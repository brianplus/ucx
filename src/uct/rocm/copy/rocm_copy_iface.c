...
static int uct_rocm_copy_iface_is_reachable_v2(const uct_iface_h tl_iface,
                                               const uct_iface_is_reachable_params_t *params)
{
    uct_rocm_copy_iface_t *iface       = ucs_derived_of(tl_iface, uct_rocm_copy_iface_t);
    uct_rocm_copy_iface_addr_t *addr   = (uct_rocm_copy_iface_addr_t*)params->iface_addr;
    ...
    if (iface->id != *addr) {
        uct_iface_unreachable((params->field_mask & UCT_IFACE_IS_REACHABLE_FIELD_INFO_STRING),
                              params->info_string, params->info_string_length,
                              "different iface->id detected. local %ld remote %ld",
                              iface->id,
                              *addr);
        return 0;
    }
                                            ...
                                            const uct_iface_addr_t *iface_addr)
{
    return uct_iface_is_reachable_v2_wrapper(tl_iface,
                                             ...
                                             uct_rocm_copy_iface_is_reachable_v2);
}
...
static uct_iface_internal_ops_t uct_rocm_copy_iface_internal_ops = {
    ...
    .iface_is_reachable_v2 = (uct_iface_is_reachable_v2_func_t)uct_rocm_copy_iface_is_reachable_v2
};
