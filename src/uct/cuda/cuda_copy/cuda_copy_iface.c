...
static int uct_cuda_copy_iface_is_reachable_v2(const uct_iface_h tl_iface,
                                            ...
                                            const uct_iface_addr_t *iface_addr)
{
    return uct_iface_is_reachable_v2_wrapper(tl_iface,
                                             ...
                                             uct_cuda_copy_iface_is_reachable_v2);
}
...
static uct_iface_internal_ops_t uct_cuda_copy_iface_internal_ops = {
    ...
    .iface_is_reachable_v2 = (uct_iface_is_reachable_v2_func_t)uct_cuda_copy_iface_is_reachable_v2
};
